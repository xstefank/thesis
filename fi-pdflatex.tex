...
In conclusion, Tram remarkably simplified the Eventuate platform for the usege of sagas. Most importantly, it introduced a simple fluent API for the saga definition and the loss of the CQRS restrictions. Altogether Tram platform makes a suitable saga solution for microservices based environment.
