...
The performance test in the scenario 1 has been executed successfully in 51 seconds. The scenario 2 met the limits of the platform when the database lock for the first command could not taken after about 5000 requests. This scenario was ran three times with the best result of 5657 completed orders in 7 minutes and 44 seconds.
...
In the scenario 1 the 1000 request has been created in 58 seconds, but because of the above mentioned issue the final count reached 2000 orders.
...
This test showed that the LRA coordinator orchestration does not influence the processing performance. The total time delay is due to the propagation between example services. The scenario 1 has been finished in exceptional 4 seconds.
