...
The performance test in the scenario 1 has been executed successfully in 51 seconds. 
...
In the scenario 1 the 1000 request has been created in 58 seconds, but because of the above issue the final count reached 2000 orders.
