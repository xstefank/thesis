...
\begin{figure}[h]
    \begin{center}
        \includegraphics[height=60mm]{images/sequence/validSagaTram.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[height=60mm]{images/sequence/validSagaLRA.png}
    \end{center}
    \caption{LRA service saga example success}
\end{figure}

\section{Invoice failure scenario}

\begin{figure}[h]
    \begin{center}
        \includegraphics[height=52mm]{images/sequence/invoiceFailSagaCQRS.png}
    \end{center}
