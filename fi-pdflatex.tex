...
The transaction consists of a sequence of operations performed on different resources. Atomicity means that all operations in the transaction are performed as if they were a single unit. 
