...
As Eventuate service is a pure CQRS saga example it has a few problems which has been reduced or removed in the later Eventuate Tram implementation which is described in the following section. 
