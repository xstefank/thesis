...
Reactive programming is conceptually based on the streams of data called observables, and functions that may be applied on them. An observable is an object that contains dynamically versatile data that represent state which may be of interest to other object. 
