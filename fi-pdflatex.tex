...
The support library module is \texttt{service-model}. This module is rosponsible for the definition of the LRA information, the specification of the exchanged JSON data formats, the specification of the communication model for the other services and the administration of common utilities.
