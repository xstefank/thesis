...
Due to their distributed character, the microservices applications development is often inclined to many issues associated with the failure processing and isolated development model. To ensure that the system is able to function even in the degraded state, these applications commonly provide a design that guarantees certain quality properties which were specified in the Reactive Manifesto \cite{reactive_manifesto} as the reactive systems.
