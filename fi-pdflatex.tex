...
Before this section provides the explanation of what the reactive systems are in distributed environments, it is appropriate to start from the basics of what the reactivity means in general terms and how these principles may be applied in software architectures. This section will introduce the motion behind the reactive design and why it is suitable for the use in the microservices environment.
