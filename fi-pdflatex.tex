...
\chapter{The order service example application API}
...
\texttt{POST /api/order} \hfill \break
\texttt{GET /api/orders} 
\texttt{GET /api/order/\{order\_id \}} 

\textbf{Shipment service}

\begin{verbatim}
POST ORDER_SERVICE/api/order
GET /api/orders
