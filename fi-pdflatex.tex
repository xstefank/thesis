...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1.0\textwidth]{images/classDiagrams/lra-definitions.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1.0\textwidth]{images/classDiagrams/lra-executor.png}
    \end{center}
