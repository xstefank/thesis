...
\begin{minted}{python}
	POST /api/order
	GET  /api/orders                       // except Axon, Eventuate
	GET  /api/order/{order_id}             // except Axon, Eventuate
\end{minted}
...
\begin{minted}{python}
	POST /api/request                      // except Axon
	POST /api/compensate                   // except Axon
	GET  /api/shipments                    // except Axon, Eventuate
	GET  /api/shipment/{shipment_id}       // except Axon, Eventuate
\end{minted}
...
\begin{minted}{python}
	POST /api/request                      // except Axon
	POST /api/compensate                   // except Axon
	GET  /api/invoices                     // except Axon, Eventuate
	GET  /api/invoice/{invoice_id}         // except Axon, Eventuate
\end{minted}

\hfill \break

\noindent
\textbf{Query service}\mintinline{python}{                                  // Axon, Eventuate}
