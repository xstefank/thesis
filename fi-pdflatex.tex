...
The main goal of this thesis is to investigate the usage of the saga pattern in the reactive architecture through the available solutions based on the Java platform.
