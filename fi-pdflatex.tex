...
The traditional requirements placed on the microservices applications are handled by the OpenShift platform. That covers for instance the service discovery, monitoring, logging and resiliency.
