...
However, \enquote{one microservice is no microservice -- they come in systems} \cite{reactive_ms_arch}. The utilization of reactive microservices must be supported by the underlying platform on which they are deployed -- the reactive microservices system.
