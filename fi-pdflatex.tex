...
The Eventuate Tram project performed exceptionally well at both scenarios where all order requests have been completed. The scenario 1 has been finished in 28 seconds and the scenario 2 in 3 minutes and 10 seconds. Overall, this framework provides a very suitable saga solution even from the performance perspective.
