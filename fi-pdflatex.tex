...
The saga pattern in this application is used to create orders. The order consists of three parts -- the production of a shipping and an invoice information and if both invocations are successful, the actual order persist. 
...
\chapter{Order service example application API}
