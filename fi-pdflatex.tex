...
Transaction processing is widely recognized as a critical technology for modern applications \cite{java_tran_processing}. It allows to group a sequence of operations in to the logical unit of work which assures that correctness guarantees are met. The achievement of these properties is
