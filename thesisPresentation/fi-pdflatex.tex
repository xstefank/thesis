...
\begin{frame}{ACID transaction}
    ...
    \end{itemize}
    \begin{tikzpicture}[overlay]
    \node[anchor=south east,xshift=-70pt,yshift=-30pt]
    at (current page.south east) {
        \includegraphics[width=50mm]{resources/vials.jpg}
    };
    \end{tikzpicture}%
...
\end{frame}
  ...
  \begin{thebibliography}{9}
      \bibitem{vials}
      http://www.24pressrelease.com/assets/news/Propylene%20Glycol%20Solvent%2017614.jpg
  \end{thebibliography}
